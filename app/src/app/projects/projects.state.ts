...
import { City, AppMerchant, AppMerchantList, Project, ProjectDetails, UserSettings } from './projects';
...
export interface ProjectsState {
  ...
  userSettings: Loadable<UserSettings>;
}
...
export const getUserSettings = createSelector(getFeatureState, s => s.userSettings);
